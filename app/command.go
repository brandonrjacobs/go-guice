...
type Command interface {
	...
	AddComponent(component ...go_guice.Component)
...
func newCommand(use, short, long string, container bool, builder Builder, help HelpWriter, extraEnv []config.EnvVar, constructors ...interface{}) Command {
	...
	return &command{
		...
		components:    make([]go_guice.Component, 0),
		builder:       builder,
		help:          help,
		provide:       option,
		extraEnv:      extraEnv,
...
func (c *command) AddComponent(components ...go_guice.Component) {
...
func (c *command) mergeComponents() []go_guice.Component {
	// Dedupe first
	dedupe := make(map[string]go_guice.Component)
	...
	merged := make([]go_guice.Component, 0, len(dedupe))
...
func (c *command) mergeEnvVars(components []go_guice.Component) []config.EnvVar {
...
func (c *command) mergeOptions(components []go_guice.Component) []fx.Option {
